...
{%endlist%}
{%warning%}
注意计算机中的任何数据类型都有其范围，32位整型的表示范围为-2^31~2^31-1
{%endwarning%}
**②题目实战**
...
{%list%}
C++等高级语言提供动态数组，当容量不足时，重新分配一段更大的空间并将其复制到新空间中
{%endlist%}
